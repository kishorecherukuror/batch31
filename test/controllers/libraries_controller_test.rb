...
class LibrariesControllerTest < ActionController::TestCase
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post :create, library: { author: @library.author, book_name: @library.book_name, category: @library.category }
    end
  ...
  test "should update library" do
    patch :update, id: @library, library: { author: @library.author, book_name: @library.book_name, category: @library.category }
    assert_redirected_to library_path(assigns(:library))
  end
